...
description: Apply Clean Code by Robert C. Martin principles when writing, reviewing, or refactoring code. Use for code quality, naming, structure, and maintainability decisions.
---
