...
description: Apply Refactoring by Martin Fowler principles when writing, reviewing, or refactoring code. Use for code quality, naming, structure, and maintainability decisions.
---
