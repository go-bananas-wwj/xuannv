...
description: Apply The Pragmatic Programmer by Andrew Hunt and David Thomas principles when writing, reviewing, or refactoring code. Use for code quality, naming, structure, and maintainability decisions.
---
