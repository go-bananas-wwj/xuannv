...
declare -a ASCEND_DEVICES=(2 3 4 5)

echo "========================================"
echo "Launching Round 5 downstream evaluation"
echo "========================================"

for i in "${!EXP_NAMES[@]}"; do
    EXP="${EXP_NAMES[$i]}"
    GPU="${ASCEND_DEVICES[$i]}"
    CONFIG="configs/round5_8gpu/${EXP}.yaml"
    CKPT="/workspace/outputs/round5_0517/${EXP}/epoch_best_epoch20.pt"
...
echo ""
echo "========================================"
echo "All Round 5 evaluations launched!"
echo "========================================"
echo "Monitor with: tmux list-sessions | grep eval_round5"
