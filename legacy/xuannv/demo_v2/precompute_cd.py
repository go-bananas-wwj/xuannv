#!/usr/bin/env python3
"""预计算常用时间窗口组合的全域变化检测数据。

用法:
    CUDA_VISIBLE_DEVICES=5,6,7 python demo_v2/precompute_cd.py
"""
...
def main():
    ...
    for version in versions:
        ...
        for pair_name, before_key, after_key in COMMON_PAIRS:
            ...
            computed_patches = int(valid_mask.sum() > 0)  # 简化，实际应该是布局中有效patch数
            # 更准确的计算：非零区域对应的patch数
            # 但我们已经知道 msg 中包含了计算 patch 数
            import re
