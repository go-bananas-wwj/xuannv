#!/usr/bin/env python3
"""V5 Mixed Scale 变化检测验证 — 像素级 Bare AUC.

用法:
    cd /workspace/xuannv
    python scripts/eval/validate_v5_bare.py \
        --config configs/qwen_v5_mixed_scale.yaml \
        --checkpoint /workspace/datasets/xuannv/WeijieWu/xuannv_embddings/outputs/aef_qwen_v5_mixed_scale/epoch_best_epoch161.pt \
...
def main():
    ...
    parser.add_argument("--config", type=str, default="configs/qwen_v5_mixed_scale.yaml")
    ...
    print("=" * 70)
    print("  V5 Mixed Scale 像素级变化检测验证 — 多卡并行")
    print("=" * 70)
