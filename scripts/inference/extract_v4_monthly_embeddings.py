#!/usr/bin/env python3
"""预提取 V4 Official 模型在 2025 年各月份的 embedding，用于变化检测评估.
...
输出:
  /workspace/outputs/aef_qwen_v4_official/monthly_embeddings_2025/{patch_id}_{month}.npy
"""
...
OUTPUT_DIR = Path("/workspace/outputs/aef_qwen_v4_official/monthly_embeddings_2025")
