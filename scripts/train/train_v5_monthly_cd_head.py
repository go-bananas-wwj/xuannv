#!/usr/bin/env python3
"""
冻结 V5 backbone，用 2025 年单月份 embedding 对训练 ChangeDetectionHead.

基于 V4 脚本修改，使用 V5 官方月度 embedding.
"""
...
OUTPUT_DIR = Path("/workspace/outputs/aef_qwen_v5_mixed_scale/monthly_cd_head")
...
def main():
    ...
    print("=" * 70)
    print(f"  V5 月度 Embedding Change Detection Head 训练  [{args.head_type}]")
    ...
    if not records:
        print("❌ No valid records found. Run extract_v5_monthly_embeddings.py first.")
        return
