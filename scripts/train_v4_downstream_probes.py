...
OUT_DIR = Path("/workspace/outputs/aef_qwen_v4_official/downstream_probes")
...
def _find_dw_file(tif_dir: Path, month: str) -> Path | None:
    ...
    if all_available:
        return tif_dir / all_available[-1]
    return None
